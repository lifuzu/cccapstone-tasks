 ...
 * 
 * Group 2 - 1: For each airport X, rank the top-10 carriers in decreasing order of on-time departure performance from X.
 *
 */
...
airports_carriers_delays = FOREACH raw_data GENERATE Origin, UniqueCarrier, DepDelayMinutes AS delay:double;
